...
export default function InVoicePending() {
    ...
    useEffect(() => {
        ...
        dispatch(StateNameDDLAPI({ data, Flag: 'Invoicepending' }))
    }, [])
    ...
    useEffect(() => {
        ...
        dispatch(SeasonDDLAPI({ data, Flag: 'Invoicepending' }))
    }, [])
    ...
    useEffect(() => {
        ...
        dispatch(MonthDDLAPI({ data, Flag: 'Invoicepending' }))
    }, [SeasonDDL.ID])
    ...
    useEffect(() => {
        ...
        dispatch(DistrictNameDDLAPI({ data, Flag: 'Invoicepending' }))
    }, [StateDDL.ID])
    ...
    useEffect(() => {
        ...
        dispatch(DealerNameDDLAPI({ data, Flag: 'Invoicepending' }))
    ...
    useEffect(() => {
        ...
        dispatch(OfficerNameDDLAPI({ data, Flag: 'Invoicepending' }))
    }, [DistrictDDL.ID])
    ...
    return (
        <>
            ...
            <main className="main-content position-relative border-radius-lg ">
                ...
                <Sidebar active='InVoicePending' listActive="invoice" />
                <div id="wrapper">
