...
export default function ReceivedInvoiceCreation() {
    ...
    useEffect(() => {
        ...
        dispatch(StateNameDDLAPI({ data, Flag: 'ReceiveOrder' }))
    }, [])
    ...
    useEffect(() => {
        ...
        dispatch(SeasonDDLAPI({ data, Flag: 'ReceiveOrder' }))
    }, [])
    ...
    useEffect(() => {
        ...
        dispatch(MonthDDLAPI({ data, Flag: 'ReceiveOrder' }))
    }, [SeasonDDL.ID])
    ...
    useEffect(() => {
        ...
        dispatch(DistrictNameDDLAPI({ data, Flag: 'ReceiveOrder' }))
    }, [StateDDL.ID])
    ...
    useEffect(() => {
        ...
        dispatch(DealerNameDDLAPI({ data, Flag: 'State_Approval' }))
    ...
    useEffect(() => {
        ...
        dispatch(OfficerNameDDLAPI({ data, Flag: 'ReceiveOrder' }))
    }, [DistrictDDL.ID])

    const { OfficerNameDDLData } = useSelector(state => state.OfficerNameDDLDataa)
    // console.log(OfficerNameDDLData)
    // const { OfficerNameDDLData } = useSelector(state => state.OfficerNameDDL)
    ...
    return (
        <>
            ...
            <main className="main-content position-relative border-radius-lg ">
                ...
                <Sidebar active='receivedinvoicecreation' listActive="invoice" />
                <div id="wrapper">
                                                        ...
                                                        tableData && tableData.table && tableData.table.length > 0 ? tableData.table.map((item, i) => (
                                                            <tr key={i}>
                                                                ...
                                                                <td style={{ textAlign: 'center' }}>
                                                                    ...
                                                                    {/* <i class="fa-solid fa-file-pdf" style={{ fontSize: '1.3rem', color: '#344767', cursor: 'pointer' }}></i> */}
                                                                </td>
                                                                <td style={{ textAlign: 'center' }}>
                                                                    {

                                                                        (item.invoiceNumber == null && item.invoiceDate == null) ?
