...
export default function FieldDayMasterPopUp({ open, handleAddCloseClick, PopUpField, handlePost, CropTypeDDLData, SeasonDDLData }) {
    ...
    return (
        <Popup open={open} closeOnDocumentClick={false} onClose={handleAddCloseClick}>
            ...
            <div className="call"> Field Day Master</div>
            <div className="modal-body">
                <div className="row details-row">
                    <div className="col-md-6 col-lg-6">
                        <div className="form-group">
                            <label className="d-block" htmlFor="NameofDepartment">Financial Year <AstricSign/></label>
                            <Select
                                // isClearable
                                // isRtl={isRtl}
                                isSearchable
                    ...
                    <div className="col-md-6 col-lg-6">
                        <div className="form-group">
                            <label className="d-block" htmlFor="NameofDepartment">Field Day(Date) <AstricSign/></label>
                            <input
                                className="form-control"
                                id="fieldDate"
                                type="date"
                                name="fieldDate"
                                value={FieldDayTextField.fieldDate}
                    ...
                    {/* <div className="col-md-6 col-lg-6">
                        <div className="form-group">
                            <label className="d-block" htmlFor="NameofDepartment">Field Day Count</label>
                            <input
                                className="form-control"
                                id="fieldCount"
                                type="text"
