...
import { RawMaterialDeleteAPI, RawMaterialExportTableDataAPI, RawMaterialTableDataAPI } from '../../../../../Redux/ClientAdminSlice/RawMaterialSlice'
import { Pegination } from '../../../../../Components/Pegination/Pegination'
import { RawMaterialExport } from './RawMaterialExport'
...
export default function RawMaterial() {
    ...
    const handleDeleteData = () => {
        dispatch(RawMaterialDeleteAPI({ PopUpField: PopUpField, handlePost, token: token, UserID: UserID, handleDeleteCloseClick }))
    }
    ...
    const { isDeleteLoading } = useSelector(state => state.RawMaterialDeleteData)
    ...
    useEffect(() => {
        ...
        dispatch(RawMaterialTableDataAPI({ data,rawMaterialTextField }))
    ...
    useEffect(() => {
        ...
        dispatch(RawMaterialExportTableDataAPI({ data,rawMaterialTextField }))
    }, [To, IsSearch, IsClear, IsPost])

    const { tableData, isLoading } = useSelector(state => state.RawMaterialTableData)
    const { RawMaterialExporttableData, isExportLoading } = useSelector(state => state.RawMaterialExportTableData)
    ...
    return (
        <>
            ...
            <main className="main-content position-relative border-radius-lg ">
                <Header />
                <Sidebar active="rawmaterial" listActive="masters" />
                <div id="wrapper">
                                    ...
                                    <div className="col-md-12 grid-margin">
                                        <div className="row page-heading">
                                            <div className="col-12 col-lg-8 mb-xl-0 align-self-center align-items-center">
                                                <h4 className="fontStyle">Raw Material</h4>
                                            </div>
                                                ...
                                                </button>
                                                {
                                                    isExportLoading ?
                                                        <button className="download-table-xls-button float-end btn btn-export btn-md pt-1 pb-1 pl-3 pr-3 mx-3"
                                                            ...
                                                            />Loading</button>
                                                        :
                                                        RawMaterialExporttableData && RawMaterialExporttableData.table && RawMaterialExporttableData.table.length > 0 &&
                                                        <RawMaterialExport
                                                            ExcelData={RawMaterialExporttableData}
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-md-6 col-lg-3">
                                                            <div className="form-group">
                                                                <label className="d-block" htmlFor="NameofDepartment">Raw Material Name</label>
                                                                <input
            ...
            {
                PopUpField.addPopUp ? <RawMaterialPopUp 
