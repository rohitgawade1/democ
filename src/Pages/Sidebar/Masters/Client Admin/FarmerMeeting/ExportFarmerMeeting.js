...
export const ExportFarmerMeeting = (props) => {
    const { ExcelData, name } = props
    return (
        <div style={{ display: 'inline', marginLeft: '0px' }}>
            <ReactHTMLTableToExcel
                id="test-table-xls-button"
                table="table-to-FarmerMasterMeetingExport"
            ...
            <table id="table-to-FarmerMasterMeetingExport" style={{ display: 'none', width: '100%' }}>
