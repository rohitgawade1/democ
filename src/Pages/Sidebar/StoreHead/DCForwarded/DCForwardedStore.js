...
export default function DCForwardedStore() {
    ...
    return (
        ...
        {isLoading && <Loading />}
            <main className="main-content position-relative border-radius-lg ">
                ...
                <Sidebar active='dcforwardedstore' />
                <div id="wrapper">
                                                ...
                                                <div className="filter-bg p-2">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-12 col-lg-2 clear">
                                                            ...
                                                            <button type="button" className="btn btn-clear text-white mr-2 mt-4 mt-md-0 mt-lg-4 mx-1 waves-effect waves-light allBtn"
                                                                onClick={handleClear}
                                                            >
                                                                Clear
                                                            </button>
                                                ...
                                                <tbody>
                                                    {
                                                        tableData && tableData.table && tableData.table.length > 0 ? tableData.table.map((item, i) => (
                                                            <tr key={i}>
                                                                ...
                                                                <td>{item.toStoreName ? item.toStoreName : '-'}</td>
                                                                <td>{item.lastModifiedDate ? moment(item.lastModifiedDate).format("DD-MM-YYYY") : '-'}</td>
