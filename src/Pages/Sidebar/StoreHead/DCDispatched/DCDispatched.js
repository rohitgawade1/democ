...
export default function DCDispatched() {
                                                        ...
                                                        tableData && tableData.table && tableData.table.length > 0 ? tableData.table.map((item, i) => (
                                                            <tr key={i}>
                                                                ...
                                                                <td style={{ textAlign: 'center' }}>
                                                                    <span
                                                                        title="Click"
                                                                        className="btn btn-outline-primary mr-2 mt-md-0 mt-lg-1 mx-2 waves-effect waves-light"
