...
import FieldDayTargetDecidePopUp from '../FieldDayTargetDecide/FieldDayTargetDecidePopUp';
import { FieldDayTargetExport } from '../FieldDayTargetDecide/FieldDayTargetExport';
import FieldVisitTargetPopUp from './FieldVisitTargetPopUp';
import { DefineFieldVisitExportTableDataAPI, DefineFieldVisitTableDataAPI } from '../../../../Redux/DistrictOfficerSlice/DefineFieldVisitSlice';
import { FieldVisitTargetExport } from './FieldVisitTargetExport';


export default function FieldVisitTarget() {
    ...
    useEffect(() => {
        ...
        dispatch(CropTypeDDLAPI({ data, Flag: 'FieldVisitDefine'  }))
    }, [])
    ...
    useEffect(() => {
        ...
        dispatch(CropNameDDLAPI({ data, Flag: 'FieldVisitDefine'  }))
    }, [CropTypeDDL.ID])
    ...
    useEffect(() => {
        ...
        if (YearValue !== 0) {
            dispatch(DefineFieldVisitTableDataAPI({ data }))
        }
    ...
    useEffect(() => {
        ...
        if (YearValue !== 0) {
            dispatch(DefineFieldVisitExportTableDataAPI({ data }))
        }

    }, [IsPost, IsClear, SeasonDDL.ID, MonthDDL.ID, CropTypeDDL.ID, CropNameDDL.ID, YearValue])

   const { tableData, isLoading } = useSelector(state => state.DefineFieldVisitTableData)
    const { FieldVisitExportTableData, isExportLoading } = useSelector(state => state.DefineFieldVisitExportTableData)
    ...
    return (
        <>
            ...
            <main className="main-content position-relative border-radius-lg ">
                ...
                <Sidebar active="decideVisit" listActive="district" />
                <div id="wrapper" >
                                    ...
                                    <div className="col-md-12 grid-margin">
                                        <div className="row page-heading">
                                            <div className="col-12 col-lg-8 mb-xl-0 align-self-center align-items-center">
                                                <h4 className="fontStyle">Define Field Visit Target</h4>
                                            </div>
                                                ...
                                                </button>
                                                {
                                                    isExportLoading ?
                                                        <button className="download-table-xls-button float-end btn btn-export btn-md pt-1 pb-1 pl-3 pr-3 mx-3"
                                                            ...
                                                            />Loading</button>
                                                        :
                                                        FieldVisitExportTableData && FieldVisitExportTableData.table && FieldVisitExportTableData.table.length > 0 &&
                                                        <FieldVisitTargetExport
                                                        ExcelData={FieldVisitExportTableData}
             ...
             {
                PopUpField.addPopUp ? <FieldVisitTargetPopUp
