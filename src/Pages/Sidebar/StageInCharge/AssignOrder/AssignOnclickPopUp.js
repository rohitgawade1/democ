...
export default function AssignOnclickPopUp({ open, handleassignCloseClick, PopUpField,setPopUpField }) {
                    ...
                    <div className="row details-row">
                        <div className="col-md-6 col-lg-6">
                            <div className="form-group">
                                <label className="d-block" htmlFor="NameofDepartment">District Name</label>
                                <Select
                                    isClearable
                                    isSearchable
                                />
