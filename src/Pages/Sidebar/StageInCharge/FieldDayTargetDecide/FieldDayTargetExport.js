...
export const FieldDayTargetExport = (props) => {
            ...
            <table id="table-to-xls474ExportAssignOrder" style={{ display: 'none', width: '100%' }}>
                ...
                <thead className="thead-dark" >
                    <tr style={{ backgroundColor: '#495057', color: "#fff", border: '1px solid' }}>
                        ...
                        <th style={{ textAlign: "center" }}>Date & Field Day</th>
                        <th style={{ textAlign: "center" }}>Field Day Count</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        ExcelData && ExcelData.table && ExcelData.table.length > 0 ? ExcelData.table.map((item, i) => (
                            <tr style={{ textAlign: "center" }}>
                                ...
                                <td>{item.m_FieldDayDate ? moment(item.m_FieldDayDate).format("DD-MM-YYYY") : '-'}</td>
