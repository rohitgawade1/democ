...
import { ArchievedOrderExportData } from './ArchievedOrderExportData'
...
export default function AchievedOrder() {
    ...
    useEffect(() => {
        ...
        dispatch(OfficerNameDDLAPI({ data, Flag:'DB_OrderAchivement' }))
                                    ...
                                    <div className="col-md-12 grid-margin">
                                        <div className="row page-heading">
                                            <div className="col-12 col-lg-8 mb-xl-0 align-self-center align-items-center">
                                                <h4 className="fontStyle"> {`Achieved Order -> ${searchName}`} </h4>
                                            </div>
                                ...
                                <div className="row">
                                    <div className="col-12 shadow table-card mt-1 mx-2">
                                        ...
                                        <div className="table-responsive ">
                                            <table id='archieved-order' cellPadding="0" cellSpacing="0" border="0" className="table table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th>Sr.No.</th>
                                                        {
