...
export default function InvoicesPendingTable() {
    ...
    const CreatePopUpClick = () => {
        setcreateActionPopUp(true)
    }

    const handleCloseClick = () => {
        setinvoiceCreatePopUp(false)
        setcreateActionPopUp(false)
    }
    ...
    return (
        <>
            ...
            {
                createActionPopUp ? <CreateActionPopUp open={createActionPopUp} handleCloseClick={handleCloseClick} /> : <></>
            }
        </>
    )
}
