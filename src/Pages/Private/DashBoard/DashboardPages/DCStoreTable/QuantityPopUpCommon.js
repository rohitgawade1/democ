...
import { DCCreatedStoreQtyPopUpAPI } from '../../../../../Redux/DashboardSlice/DCCreatedStoreSlice';

export default function QuantityPopUpCommon({ open, handleCloseClick, QuantityPopUpHeading, PopUpField,Flag }) {
    ...
    useEffect(() => {
        ...
        dispatch(DCCreatedStoreQtyPopUpAPI({ data,Flag:Flag }))

    }, [To, IsPost, From])

    const { tableData, isLoading } = useSelector(state => state.DCCreatedStoreQtyPopUpData)
