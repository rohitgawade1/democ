export default function FieldAssistantFarmerDemonstrationCard({ count, title, image,farmerDemonstrationeNavigate,screenFlag }) {
    return (
        // <div className="col-xl-4 col-sm-6 mt-3">
        <div className="col-xl-6 col-sm-6 mt-3">
            <div className="card material_stock"
                onClick={() => farmerDemonstrationeNavigate(title,screenFlag)}
            >
