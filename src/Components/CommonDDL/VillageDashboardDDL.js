...
export const VillageDashboardDDL = (props) => {
    const { VillageDashboardData, VillageDDL, setVillageDDL, PopUpField,mandatory } = props
    ...
    const handleVillageDataDDL = () => {
        ...
        if (VillageDashboardData && VillageDashboardData.table && VillageDashboardData.table.length > 0) {
            let list = VillageDashboardData.table.map((item, index) => ({
